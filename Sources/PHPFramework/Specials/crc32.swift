...
func generateCRC32(s: String) -> String {
	return (NSString(format: "%2X", MYcrc32(xmessage: s)) as String).lowercased()
}

func MYcrc32(xmessage: String, seed: UInt32? = nil) -> UInt32 {
	let message: [UInt8] = Array(xmessage.utf8)
...
private func CRC_AnyGenerator<Element>(body: @escaping () -> Element?) -> AnyIterator<Element> {
