...
//
// File:    PHPFrameworkStringPHPBase.swift
// Created: 15-JAN-2016
...
extension PHPFramework {
    ...
    /// Returns the current process title (Not done)
    ///
    /// - Parameter String: The input string
    ///
    /// - Returns: The input String
    public func cli_get_process_title(str: String) -> String {
        print("Sorry this function is not supported yet!")
        return str
    }
    ...
    ///
    /// - Returns: The input String
    public func cli_set_process_title(str: String) -> String {
        print("Sorry this function is not supported yet!")
        return str
    }

    /// Loads a PHP extension at runtime (Not done)
    ///
    /// - Parameter String: The input string
    ///
    /// - Returns: The input String
    public func dl(str: String) -> String {
        print("Sorry this function is not supported yet!")
        return str
    }

    /// Find out whether an extension is loaded (Not done)
    ///
    /// - Parameter String: The input string
    ///
    /// - Returns: The input String
    public func extension_loaded(str: String) -> String {
        print("Sorry this function is not supported yet!")
        return str
    }
    ...
    /// Gets the name of the owner of the current PHP script (Not done)
    ///
    /// - Parameter String: The input string
    ///
    /// - Returns: The input String
    public func get_current_user(str: String) -> String {
        print("Sorry this function is not supported yet!")
        return str
    }
    ...
    /// Returns information about the operating system PHP is running on (Not done)
    ///
    /// - Parameter String: The input string
    ///
    /// - Returns: The input String
    ...
    /// Prints out the credits for PHP (Not done)
    ///
    /// - Parameter String: The input string
    ///
    /// - Returns: The input String
    public func phpcredits(str: String) -> String {
        print("Sorry this function is not supported yet!")
        return str
    }

    /// Outputs information about PHP's configuration (Not done)
    ///
    /// - Parameter String: The input string
    ///
    /// - Returns: The input String
    public func phpinfo(str: String) -> String {
        print("Sorry this function is not supported yet!")
        return str
    }
